...
d4<-read.csv("data/nest_defense_pca.csv")
...
Stoop_am<-yz.bivarC.mcmc$VCV[,1]
posterior.mode(Stoop_am)

Stoop_res<-yz.bivarC.mcmc$VCV[,5]
posterior.mode(Stoop_res)

Min_am<-yz.bivarC.mcmc$VCV[,4]
posterior.mode(Min_am)

Min_res<-yz.bivarC.mcmc$VCV[,8]
